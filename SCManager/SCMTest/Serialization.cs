...
namespace SCMTest
{
    ...
    {
        ShortcutList original = new ShortcutList(); //Liste mit den zu serialisierenden Objekten
        ShortcutList deserialized = new ShortcutList(); //Liste für das Ergebnis der Deserialisierung
